...
export async function generateStaticParams() {
  // Return the slugs of our mock dealers for prerendering compiler support
  return [
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-container-max mx-auto px-gutter py-16 md:py-20">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <section className="flex-1 space-y-6 order-2 lg:order-1">
                    ...
                    <div key={listing.id} className="bg-white rounded-xl overflow-hidden border border-gray-200 shadow-card hover:shadow-xl transition-all hover:-translate-y-1 group">
                      ...
                      <div className="p-4 space-y-3">
                        ...
                        <Link 
                          ...
                          target="_blank"
                          className="w-full border border-deal-great text-deal-great font-bold py-2 rounded-lg flex items-center justify-center gap-2 hover:bg-deal-great hover:text-white transition-all text-sm mt-2 block text-center animate-in duration-200"
                        >
          ...
          <aside className="w-full lg:w-80 order-1 lg:order-2 self-start lg:sticky lg:top-24">
